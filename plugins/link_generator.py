...
async def batch(client: Client, message: Message):
    ...
    link = f"{CONFIG_DICT['PERMANENT_DOMAIN']}{base64_string}" if CONFIG_DICT['PERMANENT_DOMAIN'].lower() != "false" else f"https://telegram.me/{client.username}?start={base64_string}"
    if SHORTENER:
