...
ADMINS = [OWNER_ID, 5117106150] + [int(admin) for admin in os.getenv('ADMINS', '').split() if admin]  # Format: space-separated integers (user IDs)
...
CONFIG_DICT = sorted(CONFIG_DICT.keys())
